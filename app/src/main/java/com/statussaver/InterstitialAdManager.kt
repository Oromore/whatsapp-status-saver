 ...
 * 2. After user interaction with app (2-minute cooldown)
 */
class InterstitialAdManager(private val activity: Activity) {
    ...
    companion object {
        ...
        private const val COOLDOWN_MINUTES = 2  // Changed from 1 to 2 minutes
    ...
    fun trackAppInteraction() {
        ...
        // Check if 2-minute cooldown has passed
